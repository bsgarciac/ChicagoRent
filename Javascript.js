        ...
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            for(var i=0; i<dataLine.length; i++){
                marker = new google.maps.Marker({
                    ...
                    Distance: ((distance[i]/1000)*0.621371).toFixed(2) + " miles",
                    Price:budgetCa[json.data[i][8]],
                    icon:icon});        
                
                google.maps.event.addListener(marker, 'click', function(){ 
                   index=this.id; infoWindow.setContent('<h3>'+this.PropertyName+'</h3><p> <b> Community Area Name: </b>' + this.CommunityAreaName + '</p>' + '<p> <b> Address: </b>' + this.Address + '</p>' +  '<p> <b> Distance: </b>' + this.Distance + '</p>' + '<p> <b> Estimated Price: </b>$' + this.Price + '</p>' + '<input type="button" id="btnPrueba" value="Show more" onclick="ShowMore()"/>');
                   index=this.id; infoWindow.setContent('<h3>'+this.PropertyName+'</h3><p> <b> Community Area Name: </b>' + this.CommunityAreaName + '</p>' + '<p> <b> Address: </b>' + this.Address + '</p>' +  '<p> <b> Distance: </b>' + this.Distance + '</p>' + '<p> <b> Estimated Price: </b>$' + this.Price + '</p>' + '<input type="button" id="btnPrueba" value="Show more" onclick="ShowMore()"/>');
...
function radio(){
        ...
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            for(var i=0; i<dataLine.length; i=i+2){
                ...
                marker = new google.maps.Marker({
                    ...
                    Distance:					((distance2[i]/1000)*0.621371).toFixed(2) + " miles",
                    Price:budgetCa[json.data[j][8]],
                    icon:icon});
    ...
    document.getElementById("demo").innerHTML = ((r/1000)*0.621371).toFixed(2) + " miles";
    getZoom();
}
...
function safe(){
    ...
    function mainCrimes(){
        ...
        if(activeCrimes==1){
            ...
            document.getElementById("parrafo").innerHTML="<br><br>You never listen to me! ";
    ...
    //Libraries
        ...
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            for(var i=0; i<dataLine.length; i++){
                ...
                google.maps.event.addListener(marker, 'click', function(){ 
                   index=this.id; infoWindow.setContent('<h3 style="color: orange;">Library: '+this.name+'</h3><p> <b> Hour of Operation: </b>' + this.hour + '</p>' + '<p> <b> Address: </b>' + this.address + '</p>' + '<p> <b> Phone: </b>' + this.phone + '</p>' + '<p> <b> Web Site: </b>' + this.ws);
                    infoWindow.open(map, this);
                });
            }
    ...
    function PS(){
        ...
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            for(var i=0; i<dataLine.length; i++){
                ...
                google.maps.event.addListener(marker, 'click', function(){ 
                   index=this.id; infoWindow.setContent('<h3 style="color: gray;"> Police Station: '+this.name+ '</h3></p>' + '<p> <b> Address: </b>' + this.address + '</p>' + '<p> <b> Phone: </b>' + this.phone + '</p>' + '<p> <b> Web Site: </b>' + this.ws);
                    infoWindow.open(map, this);
                });
            }
    ...
    function parks(){
        ...
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            for(var i=4; i<dataLine.length; i++){
                ...
                google.maps.event.addListener(marker, 'click', function(){ 
                   index=this.id; infoWindow.setContent('<h3 style="color: darkgreen;">Park: '+this.name+ '</h3></p>' + '<p> <b> Address: </b>' + this.address + '</p>' + '<p> <b> Type: </b>' + this.type);
                    infoWindow.open(map, this);
                });
            }
    ...
    function condoms(){
        ...
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            for(var i=0; i<dataLine.length; i++){
                ...
                google.maps.event.addListener(marker, 'click', function(){ 
                   index=this.id; infoWindow.setContent('<h3 style="color: red;">Condom distributor: '+this.name+ '</h3></p>' + '<p> <b> Address: </b>' + this.address + '</p>' + '<p> <b> Type: </b>' + this.type);
                    infoWindow.open(map, this);
                });
            }
    ...
    function GS(){
        ...
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            for(var i=0; i<dataLine.length; i++){
                ...
                google.maps.event.addListener(marker, 'click', function(){ 
                   index=this.id; infoWindow.setContent('<h3 style="color: blue;"> Grocery Store: '+this.name+ '</h3></p>' + '<p> <b> Address: </b>' + this.address + '</p>' + '<p> <b> Type: </b>' + this.type);
                    infoWindow.open(map, this);
                });
            }
...
function change(x){
    ...
    switch(x){
        ...
        case 5:
            document.getElementById("yo").src="imagenes/pnot.png";
            document.getElementById("parrafo").innerHTML="It seems like this Community <br> Area doesn't have any place to rent. <br> But don't worry! You don't need <br> this community area, <br> this community area needs you. <br> Please select another one";
        break;
        case 6:
        ...
        case 10:
            document.getElementById("yo").src="imagenes/pclear.png";
            document.getElementById("parrafo").innerHTML="<b> Green:</b> Price below $700.  <br> <b> Yellow:</b> Price between <br> $700 and $1000.<br> <b>Orange:</b>Price between <br> $1000 and $1300. <br><b>Red:</b> Price over $1300. <br> <i> Prices are estimated.";        
        break;
		case -4:
			document.getElementById("yo").src="imagenes/daniela2.png";
            document.getElementById("parrafo").innerHTML="You are watching <br> the <b>bar graphic </b> of crimes in the community areas (year prior).<br> You can compare  this with the community area of the house that you are looking at.";
		break;
		case -5:
			document.getElementById("yo").src="imagenes/daniela3.png";
            document.getElementById("parrafo").innerHTML="<br>I forgot to tell you that <br> you are going to see <br> bigger the icons of houses that <br> have better scores.";
		break;
        }
    }
...
function weather(){
    ...
    var xmlhttp = new XMLHttpRequest(); 
    var url = "https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?q=chicago&appid=9830879c002bb5e78eebb68edc11b148";
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
    xmlhttp.onreadystatechange = function() {
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
